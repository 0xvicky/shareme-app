...
1) @sanity/client : To connect the sanity backend to the react frontend
...
5) react-loader-spinner: To get the loaders from react library used in app

6) react-masonry-css: Package allows to make nice grid for the images
